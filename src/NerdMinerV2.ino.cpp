...
void setup()
{
  ...
  TaskHandle_t minerTask1, minerTask2 = NULL;
    ...
    #if defined(CONFIG_IDF_TARGET_ESP32)
    xTaskCreatePinnedToCore(minerWorkerHw, "MinerHw-0", 3584, (void*)0, 5, &minerTask1, 1); // Reduced for ESP32 classic
    #else
    xTaskCreatePinnedToCore(minerWorkerHw, "MinerHw-0", 4096, (void*)0, 6, &minerTask1, 1);
    #endif
  #else
    #if defined(CONFIG_IDF_TARGET_ESP32)
    xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-0", 5000, (void*)0, 1, &minerTask1, 0); // Reduced for ESP32 classic
    #else
