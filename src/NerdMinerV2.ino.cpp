...
void setup()
{
  ...
  BaseType_t res1 = xTaskCreatePinnedToCore(runMonitor, "Monitor", 9500, (void*)monitor_name, 1, NULL, 0);
  #else
  BaseType_t res1 = xTaskCreatePinnedToCore(runMonitor, "Monitor", 10000, (void*)monitor_name, 1, NULL, 0);
  #endif
  ...
  BaseType_t res2 = xTaskCreatePinnedToCore(runStratumWorker, "Stratum", 12000, (void*)stratum_name, 1, NULL, 0);
 #elif defined(ESP32_2432S028R) || defined(ESP32_2432S028_2USB)
  // Free a little bit of the heap to the screen
  BaseType_t res2 = xTaskCreatePinnedToCore(runStratumWorker, "Stratum", 13500, (void*)stratum_name, 1, NULL, 0);
 #else
  BaseType_t res2 = xTaskCreatePinnedToCore(runStratumWorker, "Stratum", 15000, (void*)stratum_name, 1, NULL, 0);
 #endif
  ...
  TaskHandle_t minerTask1, minerTask2 = NULL;
    ...
    #if defined(CONFIG_IDF_TARGET_ESP32)
    xTaskCreatePinnedToCore(minerWorkerHw, "MinerHw-0", 3584, (void*)0, 20, &minerTask1, 1); // Reduced for ESP32 classic
    #else
    xTaskCreatePinnedToCore(minerWorkerHw, "MinerHw-0", 4096, (void*)0, 20, &minerTask1, 1);
    #endif
  #else
    #if defined(CONFIG_IDF_TARGET_ESP32)
    xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-0", 5000, (void*)0, 20, &minerTask1, 0); // Reduced for ESP32 classic
    #else
    xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-0", 6000, (void*)0, 20, &minerTask1, 0);
    #endif
  #endif
  ...
  #if defined(CONFIG_IDF_TARGET_ESP32)
  xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-1", 5000, (void*)1, 20, &minerTask2, 0); // Reduced for ESP32 classic
  #else
  xTaskCreatePinnedToCore(minerWorkerSw, "MinerSw-1", 6000, (void*)1, 20, &minerTask2, 0);
  #endif
